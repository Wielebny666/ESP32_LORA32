...
as3933_init_cmd_t as3933_config_register[] = {
	...
	{R0, 0x6E},
	{R1, 0x2A},
	// AGC_T-LIM = 0 Had improved stability (RSSI value constant), but was causing lost LF. Changed back
	{R2, 0x20},
	{R3, 0x3F},
	{R4, 0x30},
	// reduce Off time.
...
//        .mode = 1,                                 //SPI mode 1
//        .spics_io_num = config.spics_io_num,                   //CS pin
//        .flags = SPI_DEVICE_POSITIVE_CS,
//        .queue_size = 1, //We want to be able to queue 7 transactions at a time
//        .command_bits = 8};
//
//    //Initialize the SPI bus
//    ESP_ERROR_CHECK(spi_bus_initialize(config.spi_host_device, &buscfg, 0));
//    //Attach the Device to the SPI bus
//    ESP_ERROR_CHECK(spi_bus_add_device(config.spi_host_device, &devcfg, &as3933));
//}
//
...
//void as3933_init(const spi_interface_t *device)
//{
//	as3933 = device;
//}
...
uint16_t as3933_get_wakeup_pattern_16bit()
{
	...
	patt_t patt = {
		.r5.patt2b = 0,
		.r6.patt1b = 0};
	spi_read_byte(R6, &patt.r6.patt1b);
	spi_read_byte(R5, &patt.r5.patt2b);
